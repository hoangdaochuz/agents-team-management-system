...
import (
	...
	"github.com/aaks/server/services/agent/internal/application/settings"
	"github.com/aaks/server/services/agent/internal/domain/settings"
)
...
// New builds the HTTP adapter. token is AGENT_INTERNAL_TOKEN; the decrypt
