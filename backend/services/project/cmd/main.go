...
import (
	...
	"github.com/aaks/server/services/project/internal/infrastructure/repository"
...
func register(ctx context.Context, mux *http.ServeMux, log *slog.Logger) error {
	...
	messaging.New(log, messaging.WorkspaceCreatedHandler{App: app}).Start(ctx, os.Getenv("KAFKA_BROKERS"))
