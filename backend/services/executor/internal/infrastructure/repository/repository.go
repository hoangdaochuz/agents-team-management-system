...
import (
	...
	"github.com/aaks/server/services/executor/internal/domain"
	"github.com/aaks/server/services/executor/internal/infrastructure/repository/artifact"
	"github.com/aaks/server/services/executor/internal/infrastructure/repository/finding"
	"github.com/aaks/server/services/executor/internal/infrastructure/repository/run"
	"github.com/aaks/server/services/executor/internal/infrastructure/repository/step"
)
